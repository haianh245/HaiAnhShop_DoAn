...
namespace HaianhShop.Web.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ActionResult Category(int id, int page = 1, string sort = "")
        {
            ...
            int totalRow = 0;
            var productModel = _productService.GetListProductByCategoryIdPaging(id, page, pageSize, sort, out totalRow); var productViewModel = Mapper.Map<IEnumerable<Product>, IEnumerable<ProductViewModel>>(productModel);
